            ...
            override fun onCreate(db: SupportSQLiteDatabase) {
                Executors.newSingleThreadScheduledExecutor()
                    .execute(Runnable {
                        ...
                        db.execSQL("insert into Stock values (\"AMD\", \"\", 0, 600, \"암드\", \"+AMD\", 'c_amd', 1);")
                        ...
                        db.execSQL("insert into Stock values (\"KO\", \"\", \"20080\", \"700\", \"코카콜라\", \"CocaCola\",'c_ko', 1);")
                        ...
                        db.execSQL("insert into Stock values (\"NVDA\", \"\", \"20080\", \"700\", \"엔비디아\", \"NVIDIA\",'c_nvda', 1);")
                        ...
                        db.execSQL("insert into Stock values (\"TSLA\", \"\", \"20080\", \"700\", \"테슬라\", \"TESLA\", 'c_tsla', 1);")
